...
// the top nav for communities (black bar across every page)
function bones_community_nav() {
	// display the wp3 menu if available
    wp_nav_menu(array(
    	'container' => false,                           // remove nav container
    	'container_class' => 'menu clearfix',           // class of container (should you choose to use it)
    	'menu' => __( 'Top of Page TEDxABQ Community Menu', 'bonestheme' ),  // nav name
    	'menu_class' => 'nav community-nav clearfix',         // adding custom nav class
