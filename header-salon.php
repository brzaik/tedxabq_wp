    ...
    <div id="container">
      ...
      <header class="header" role="banner">
        ...
        <div id="inner-header" class="wrap clearfix">
          ...
          <p id="logo" class="h1"><a href="<?php echo home_url(); ?>/salons" rel="nofollow"><img src="<?php echo get_template_directory_uri(); ?>/library/images/tedxabqSalons_mainlogo.png" /></a></p>
